    ...
    this.ctx.container.innerHTML = `
      <div class="header">
        <div class="header-left">
          ...
          <span class="logo" style="margin-right: 8px;">OSIRIS</span><span class="version" style="margin-right: 16px;">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge" style="margin-right: 16px;">BETA</span>' : ''}
        ...
        return `
          ...
          <span class="logo" style="margin-right: 8px;">OSIRIS</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
