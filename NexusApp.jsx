...
const C = {
  ...
  brandLight: "#F3E8FF",
  brandMid: "#A78BFA",     // Secondary
  accent: "#8B5CF6",
  critical: "#DC2626",     // Action Red
  criticalLight: "#FEF2F2",
  criticalBorder: "#FECACA",
  high: "#F97316",         // CTA Orange
  highLight: "#FFF7ED",
  highBorder: "#FED7AA",
  medium: "#F59E0B",
  mediumLight: "#FEF3C7",
  ...
  card: "#FFFFFF",
  sidebar: "#4C1D95",      // Dark purple sidebar
  sidebarHover: "#5B21B6",
        ...
        <div style={{ width: 380, background: "white", borderRadius: 16, boxShadow: "0 12px 48px rgba(15,23,42,0.16)", border: "1px solid #E2E8F0", overflow: "hidden", animation: "fadeUp 0.22s ease" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 18px", borderBottom: "1px solid #F1F5F9", background: "#FAFBFC" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div>
                <div style={{ fontSize: 13, fontWeight: 800, color: C.text, fontFamily: "'Sora',sans-serif", letterSpacing: "-0.01em" }}>NEXUS</div>
    ...
    <aside style={{ width: 220, minWidth: 220, background: C.sidebar, display: "flex", flexDirection: "column", height: "100vh", position: "sticky", top: 0, fontFamily: "'Fira Sans',system-ui,sans-serif" }}>
      ...
      <div style={{ padding: "20px 20px 14px", borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <div style={{ fontSize: 16, fontWeight: 900, color: "white", letterSpacing: "0.06em", fontFamily: "'Fira Code',sans-serif" }}>NEXUS</div>
...
export default function NexusApp() {
  ...
  const PAGE_META = {
    ...
    analysis: { title: "Risk Analysis & Playbook", subtitle: "Full 11-step NEXUS workflow output" },
